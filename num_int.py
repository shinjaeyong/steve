...
def trapezoid1(f, xi, xe, n = 100):
    ...
    for k in  xrange(n):
        ...
        # k+1번째 x 값을 다음 구획 시작점의 x 값으로 지정
        xk = xk1
...
def simpson2(f, xi, xe, n=100, b_verbose=False):
    ...
    :param xe: 정적분 끝 지점
    :param n: 구획을 나누는 갯수
    :param b_vebose: 함수 실행 중 상세 내용 표시 여부
    :return: f(x) 를 xi ~ xe 구간에서 정적분한 근사값
    """
    # 초기화 시작
